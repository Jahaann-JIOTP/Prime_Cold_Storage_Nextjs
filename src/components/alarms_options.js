    ...
    return (
        <div>
            ...
            <nav className={`mt-4 text-black text-lg slide-from-right`}>
                ...
                {/* <Link href="/alarms" className={`block py-3 px-4 hover:bg-[#E5E5E5] text-[14px] rounded ${pathname == "/alarms" ? 'border-t border-b border-[#1f5897] bg-[#95bfed] text-gray-800 font-semibold shadow-md mx-2' : ''}`}>
                1- Configure Alarms
                </Link> */}
